...
autorun_path=/apollo/data/drivefuzz/24h_Town01/result_autorun_"$(date +%Y%m%d_%H%M%S)"
...
while true; do
    ...
    python ./fuzzer.py -o "$autorun_path/output_$retry_time" -s seed2 -p 4000 --reload-port 7692 --town 1
